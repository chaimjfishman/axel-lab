# -*- coding: utf-8 -*-
"""
Created on Wed Jul 15 17:42:53 2015
...
#----------------------------------------------------------------  
    ...
    def createGiveOdorCheckbutton(self):
        ...
        self.OdorButton = Checkbutton(self, text = 'NO odor',
                                      variable = self.var)
        self.OdorButton.grid(sticky = W)
...
#----------------------------------------------------------------------
    def createStartButton(self):
        ...
        #..method is invoked.
        self.startButton = Button(self, text = 'Run touch sensor',
    ...
    def programLoop(self):
        """Main program loop."""
        self.myObject.setOutputState(2, False)
        self.myObject.setOutputState(3, False)
        #set the output state to False so no odor is given
        self.myObject.setOutputState(4, False)
        ...
        #If time the program was set to run has not yet passed...
            ...
            #..Indicates that the mouse is there)..
                ...
                if self.var.get() != 1:
                #if the 'NO odor' button is NOT equal to 1
                #(i.e. it's NOT checked)..
                    self.myObject.setOutputState(2, True)
                    self.myObject.setOutputState(3, True)
                    #odor is released.
...
#==============================================================================
#         for items in self.waterList:
#             self.IRbroken.insert(items*3, items)
#==============================================================================
